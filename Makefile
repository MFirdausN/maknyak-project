...
.PHONY: help doctor bootstrap onboard build-images infra-up up dev down logs check smoke phase1-test phase2-test phase3-test ai-up disk-audit disk-clean
